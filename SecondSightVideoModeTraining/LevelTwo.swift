...
class LevelTwo: UIViewController {
    ...
    let defaultSquareWidth = CGFloat(225)
    let defaultSquareHeight = CGFloat(225)
    ...
    func exportGeneralData() {
        ...
        do {
            ...
            let url = dir.appendingPathComponent("1-O_" + trialStatus + "_" + currentDate + "_level1_run" + String(currentTrial) + ".txt")
